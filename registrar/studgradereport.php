        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-12 col-md-8 col-lg-8">
                    <h2><i>Student grade report</i></h2>
                </div>
            </div>
            ...
            <div class="row">
                    ...
                    <form method="post" action="">
                        <div class="form-row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <button type="submit" class="btn btn-primary" name="graderep" >Fetch grade report</button>
                            </div>
                ...
                <?php
                if(isset($_POST['graderep'])) {
                    $obj = new Queries;
                    $obj->fetchGradeReport();
                    echo"<br>";
